(function () {
    ...
    ***************************************************************************** */
    ...
    async function initSnapLayout() {
        ...
        window.__SNAP_LAYOUT_CHANGE_TARGET__ = changeTarget;
        window.__SNAP_LAYOUT_CHANGE_PADDING__ = changePadding;
        window.__SNAP_LAYOUT_ATTACH__ = attach;
